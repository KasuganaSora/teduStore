        ...
        <div class="rs_content">
            <form id="user-form">
                ...
                <div class="rs_content_username">
                    ...
                    <input class="ed_username" value="${user.username}" name="username" id="username" style="display: none;"/>
                ...
                <div class="rs_content_mail">
                    ...
                    <input class="ed_email" value="${user.email}" id="email" name="email" style="display: none;"/>
                    <span class="rs_mail">${user.email}</span>
                    <span class="same_click change_mail">更改邮箱</span>
                    <span class="mailMsg"></span>
                </div>
                <!--保存按钮-->
                <div class="save" id="saveUser">
                    保存更改
                </div>
                <div>
...
<script type="text/javascript">
    ...
    $("#saveUser").click(function () {
        var formInfo = $("#user-form").serializeObject();
        ...
        $.ajax({
            ...
            "success":function(data){
                ...
                location.href='${ctx}/user/showPersonInfo.do';
            }
        })
    })
</script>
